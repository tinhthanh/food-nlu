    ...
    var WefinexComponent = /*#__PURE__*/function () {
      ...
      _createClass(WefinexComponent, [{
        ...
        value: function ngAfterViewInit() {
          ...
          var modeSwitch = this.document.querySelector('.mode-switch');
          modeSwitch.addEventListener('click', function () {
            _this6.document.documentElement.classList.toggle('dark');
          ...
          this.document.querySelector('.messages-btn').addEventListener('click', function () {
            _this6.document.querySelector('.messages-section').classList.add('show');
          });
          this.document.querySelector('.messages-close').addEventListener('click', function () {
            _this6.document.querySelector('.messages-section').classList.remove('show');
          });
        }
      }, {
        key: "trackByFn",
    ...
    var FirestoreCrudService = /*#__PURE__*/function () {
      ...
      _createClass(FirestoreCrudService, [{
        ...
        value: function add(entity, id) {
          ...
          return new Promise(function (resolve, reject) {
            if (id) {
              ...
              _this7.collection.doc(id).set(firebaseSerialize(entity)).then(function (ref) {
                resolve(entity);
              });
            } else {
              // If no ID is set, allow Firestore to Auto-Generate one
              _this7.collection.add(firebaseSerialize(entity)).then(function (ref) {
        ...
        value: function update(entity) {
          ...
          return new Promise(function (resolve, reject) {
            _this8.collection.doc(entity.id).set(firebaseSerialize(entity)).then(function () {
        ...
        value: function _delete(id) {
          ...
          return new Promise(function (resolve, reject) {
            _this9.collection.doc(id)["delete"]().then(function () {
              resolve();
            });
          });
        }
